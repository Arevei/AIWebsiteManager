    ...
    <header className="sticky top-0 z-50 glass-nav px-6 py-3.5" data-testid="marketing-nav">
      <div className="max-w-[1400px] mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-7 text-sm font-medium text-[color:var(--ar-ink-2)]">
          <a href="#how" data-testid="nav-how" className="hover:text-[color:var(--ar-ink)] transition-colors">How it works</a>
          <a href="#features" data-testid="nav-features" className="hover:text-[color:var(--ar-ink)] transition-colors">Features</a>
          <a href="#pricing" data-testid="nav-pricing" className="hover:text-[color:var(--ar-ink)] transition-colors">Pricing</a>
